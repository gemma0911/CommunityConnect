                                ...
                                <div class="w-full md:w-1/2 px-10">
                                    ...
                                    <div>
                                        ...
                                        <div class="inline-block align-bottom">
                                            <button onClick={() => setShowForm(!showForm)} class="m-[20px] bg-yellow-300 opacity-75 hover:opacity-100 text-yellow-900 hover:text-gray-900 rounded-full px-10 py-2 font-semibold"><i class="mdi mdi-cart -ml-2 mr-2"></i>THUÊ CÓ TÀI XẾ</button>
                                            <button class="m-[20px] bg-yellow-300 opacity-75 hover:opacity-100 text-yellow-900 hover:text-gray-900 rounded-full px-10 py-2 font-semibold"><i class="mdi mdi-cart -ml-2 mr-2"></i>THUÊ TỰ LÁI</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
